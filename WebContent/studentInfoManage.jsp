...
<script type="text/javascript">
	...
	function searchStudent(){
		$('#dg').datagrid('load',{
			...
			sex:$('#s_sex').combobox("getValue"),   			//获取性别下拉框的值
			bbirthday:$('#s_bbirthday').datebox("getValue"), 	//获取出生日期范围起始值
			ebirthday:$('#s_ebirthday').datebox("getValue"), 	//获取出生日期范围结束值
			gradeId:$('#s_gradeId').combobox("getValue")		//获取班级下拉框的值，其值是id
		});
	}
	...
	function openStudentAddDialog(){   //添加信息按钮
		$("#dlg").dialog("open").dialog("setTitle","添加学生信息");
		url="studentSave";
	}
	
	function saveStudent(){     //保存学生信息
		$("#fm").form("submit",{
			url:url,
			onSubmit:function(){
				if($('#sex').combobox("getValue")==""){    //判断性别输入是否为空
					$.messager.alert("系统提示","请选择性别");
					return false;
				}
				if($('#gradeId').combobox("getValue")==""){    //判断性别输入是否为空
	...
	function openStudentModifyDialog(){
		var selectedRows=$("#dg").datagrid('getSelections'); //获取选中的信息
...
<body style="margin: 5px;">
	<table id="dg" title="学生信息" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="stuName" width="80" align="center">姓名</th>
				...
				<th field="gradeName" width="100" align="center">所在班级</th>
				<th field="email" width="150" align="center">电子邮件</th>
				<th field="stuDesc" width="250" align="center">详情</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>&nbsp;学号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo" size="12"/>
		
		&nbsp;姓名：&nbsp;<input type="text" name="s_stuName" id="s_stuName" size="7"/>
		...
		&nbsp;出生日期：&nbsp;<input type="text" class="easyui-datebox" name="s_bbirthday" id="s_bbirthday"  editable="false" size="9"/>
		->
		<input type="text" class="easyui-datebox" name="s_ebirthday" id="s_ebirthday"  editable="false" size="9"/>
		
		&nbsp;所属班级：&nbsp;<input class="easyui-combobox" id="s_gradeId" name="s_gradeId"  size="9" 
	...
	<div id="dlg" class="easyui-dialog" style="width:580px;height:350px;padding: 10px 20px" 
		...
		<form id="fm" method="post">
			<table cellpadding="5px;">
				...
				<tr>
					<td>性别：</td>
					<td><select class="easyui-combobox" id="sex" name="sex" editable="false" panelHeight="auto" style="width:160px">
								<option value="">请选择...</option>
								<option value="男">男</option>
								<option value="女">女</option>
						</select>
					...
					<td></td>
					<td>出生日期：</td>
					<td><input type="text" class="easyui-datebox" name="birthday" id="birthday"  required="true" editable="false" /></td>
				</tr>
				<tr>
					<td>所属班级：</td>
					<td><input class="easyui-combobox" id="gradeId" name="gradeId"   style="width:160px"
						data-options=" editable:false,valueField:'id',textField:'gradeName',url:'gradeComboList'"/>
					</td>
					<td></td>
					<td>电子邮件：</td>
