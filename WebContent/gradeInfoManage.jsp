...
<script type="text/javascript">
	...
	function openGradeAddDialog(){   //添加信息按钮
		$("#dlg").dialog("open").dialog("setTitle","添加班级信息");
		url="gradeSave";
	}
	
	function openGradeModifyDialog(){  //修改信息按钮
	...
	function closeGradeDialog(){   //添加班级信息关闭按钮
		$("#dlg").dialog("close");
		resetValue();
	}
	
	function resetValue(){  //清空信息
		$("#gradeName").val("");
		$("#gradeDesc").val("");
	}
	
	function saveGrade(){    //保存班级信息
		$("#fm").form("submit",{
			url:url,
			onSubmit:function(){
